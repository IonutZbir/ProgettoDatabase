...
#### 2. Visualizza i turni di tutti i dipendendti per una data giornata
...
#### 3. Visualizza le prenotazioni di un cliente
...
#### 4. Visualizza le entrate di una giornata di un negozio
